        ...
        <Card className="flex-grow flex flex-col w-[300px] h-[540] mr-4">
          ...
          <CardContent className="flex-grow flex flex-col overflow-y-auto">
            <div className="h-[200px]">
                <Accordion type="multiple" collapsible="true" defaultValue={videos[0].title}>
                    <AccordionItem value={videos[0].title}>
                        <AccordionTrigger>Videos</AccordionTrigger>
                        {videos.map((video,index)=>(<AccordionContent key={`${video.url}-${video.title}`}>
                            <Button variant="ghost" onClick={()=>handleIput(video.title,"video")}><Youtube />{video.title}</Button>
                        </AccordionContent>))}
                    </AccordionItem>
                    <AccordionItem value="item-1">
                        ...
                        <AccordionContent>
                            ...
                            <blockquote className="mt-6 border-l-2 pl-6 italic">Coming Soon...</blockquote>
                        </AccordionContent>
                    </AccordionItem>
                </Accordion>
            </div>
